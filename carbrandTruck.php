...
<head>
    <meta charset="UTF-8">
    <title>TRUCK Collection - REVS</title>
    <style>
...
<div class="container">
    <h1 class="header-title">TRUCK <span>Collection</span></h1>

    <?php
    // 1. Get unique brands that have cars categorized as 'TRUCK'
    $brand_query = "SELECT DISTINCT brand FROM cars WHERE type = 'TRUCK'";
        ...
        <div class="listing-item">
            <div class="brand-header" onclick="toggleBrand('<?php echo $cleanID; ?>')">
                ...
                <div class="brand-info">
                    <h2><?php echo $bName; ?> <span>TRUCK</span></h2>
            ...
            <div id="<?php echo $cleanID; ?>" class="models-dropdown">
                <?php
                // 2. Fetch all cars for this specific brand that are 'TRUCK' type
                $car_query = "SELECT * FROM cars WHERE brand = '$bName' AND type = 'TRUCK'";
    ...
    <?php 
        ...
        echo "<p style='text-align:center; color:#666;'>No TRUCK cars found in the database yet.</p>";
    }
    ?>
