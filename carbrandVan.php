...
<head>
    <meta charset="UTF-8">
    <title>VAN Collection - REVS</title>
    <style>
...
<div class="container">
    <h1 class="header-title">VAN <span>Collection</span></h1>

    <?php
    // 1. Get unique brands that have cars categorized as 'VAN'
    $brand_query = "SELECT DISTINCT brand FROM cars WHERE type = 'VAN'";
        ...
        <div class="listing-item">
            <div class="brand-header" onclick="toggleBrand('<?php echo $cleanID; ?>')">
                ...
                <div class="brand-info">
                    <h2><?php echo $bName; ?> <span>VAN</span></h2>
            ...
            <div id="<?php echo $cleanID; ?>" class="models-dropdown">
                <?php
                // 2. Fetch all cars for this specific brand that are 'VAN' type
                $car_query = "SELECT * FROM cars WHERE brand = '$bName' AND type = 'VAN'";
    ...
    <?php 
        ...
        echo "<p style='text-align:center; color:#666;'>No VAN cars found in the database yet.</p>";
    }
    ?>
