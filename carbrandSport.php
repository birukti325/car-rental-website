...
<head>
    <meta charset="UTF-8">
    <title>Sport Collection - REVS</title>
    <style>
...
<div class="container">
    <h1 class="header-title">Sport <span>Collection</span></h1>

    <?php
    // 1. Get unique brands that have cars categorized as 'Sport'
    $brand_query = "SELECT DISTINCT brand FROM cars WHERE type = 'Sport'";
        ...
        <div class="listing-item">
            <div class="brand-header" onclick="toggleBrand('<?php echo $cleanID; ?>')">
                ...
                <div class="brand-info">
                    <h2><?php echo $bName; ?> <span>Sport</span></h2>
            ...
            <div id="<?php echo $cleanID; ?>" class="models-dropdown">
                <?php
                // 2. Fetch all cars for this specific brand that are 'Sport' type
                $car_query = "SELECT * FROM cars WHERE brand = '$bName' AND type = 'Sport'";
    ...
    <?php 
        ...
        echo "<p style='text-align:center; color:#666;'>No Sport cars found in the database yet.</p>";
    }
    ?>
